...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <h1 className="f24 bold mt16 mb16">Privacy Policy</h1>
      <div className="r bs-3 bg-1 p20 mb20">
        ...
        <h2 className="bold mb16">What is Personal</h2>
        <p className="mb16">
        ...
        <h2 className="bold mb16">Sensitive Information</h2>
        <p className="mb16">
        ...
        <h2 className="bold mb16">Third Parties</h2>
        <p className="mb16">
        ...
        <h2 className="bold mb16">Disclosure of Personal Information</h2>
        <div className="mb16">
        ...
        <h2 className="bold mb16">Security of Personal Information</h2>
        <p className="mb16">
        ...
        <h2 className="bold mb16">Policy Updates</h2>
        <p className="mb16">
          This Policy may change from time to time and is available on our
          website.
        </p>
        <h2 className="bold mb16">Privacy Policy Complaints and Enquiries</h2>
        <p className="mb16">
